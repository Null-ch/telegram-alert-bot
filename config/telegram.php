...
return [
    ...
    */
    'bots' => [
        'botMo' => [
            'token'               => env('TELEGRAM_MO_BOT_TOKEN'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH'),
            'webhook_url'         => env('TELEGRAM_MO_WEBHOOK_URL'),
            'commands'            => [
            ],
        ],
        'botInfocur' => [
            'token'               => env('TELEGRAM_INFOCUR_BOT_TOKEN'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH'),
            'webhook_url'         => env('TELEGRAM_INFOCUR_WEBHOOK_URL'),
            'commands'            => [
            ],
        ],
        'botOrion' => [
            'token'               => env('TELEGRAM_ORION_BOT_TOKEN'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH'),
            'webhook_url'         => env('TELEGRAM_ORION_WEBHOOK_URL'),
            'commands'            => [
            ],
        ],
        'test' => [
